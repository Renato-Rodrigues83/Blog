      ...
      <div className="container space-y-12 px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 lg:gap-12">
          <article className="bg-gray-600 rounded-lg overflow-hidden border-gray-400 border">
            ...
            <header className="p-4 mt-8 md:mt-12 md:p-6 lg:p-12 pb-0">
            ...
            <div className="prose prove-invert maxmax-w-none px-4 mt-12 md:px-6 lg:px-12">
